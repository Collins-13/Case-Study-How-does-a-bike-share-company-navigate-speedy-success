...
df %>%
  ...
  theme_minimal()
```
![Average Ride Duration by Day of Week](https://github.com/Collins-13/Case-Study-How-does-a-bike-share-company-navigate-speedy-success/raw/main/Cyclistic-Capstone-Project/visualizations/Average_ride_duration_by_day_of_week.jpeg)
